                ...
                <div class="sb-sidenav-menu">
                    ...
                    {{-- Menu clients --}}
                        ...
                        <div class="collapse" id="pack" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="#">Nouveau pack</a>
                                <a class="nav-link" href="#">Liste des packs</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="pack" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="#">Nouveau service</a>
                                <a class="nav-link" href="#">Liste des services</a>
                            </nav>
                        </div>
